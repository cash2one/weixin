...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>干货 - 有思想，有内容的微信文章 - 聪悟网</title>
		<meta name="keywords" content="干货  - 有思想，有内容的微信文章 - 聪悟网" />
	...
	<div class="main e_col w4_5 main_col">
		...
		<div class="pagination pagination-centered">
	 	<ul style="padding-top: 2px;">
			<li><a href="${_contextPath}/weixin/hot.htm">首页</a></li>
			<c:if test="${not empty nextId }">
			<li><a href="${_contextPath}/weixin/hot-${tagid}-${nextId}.htm">下一页</a></li>
			</c:if>
		</ul>
		</div>
	</div>
