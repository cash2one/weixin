	...
	<div class="main e_col w4_5 main_col">
		...
		<c:forEach var="weiXinArticle" items="${weiXinArticleList}" varStatus="index">
			...
			<div class="feed_item_question">
				...
				<div>
					<a href="${_contextPath}/weixin/add_one.htm?key=Xiaozd12&titlehash=${weiXinArticle.titlehash}" target="_blank">拉入优秀</a>
				</div>
			</div>
			</div>
			</div>
		...
		<div class="pagination pagination-centered">
	 	<ul style="padding-top: 2px;">
			<li><a href="${_contextPath}/weixin/to_add_list.htm?key=Xiaozd12">首页</a></li>
			<li><a href="${_contextPath}/weixin/to_add_list.htm?key=Xiaozd12&nextId=${nextId}">下一页</a></li>
		</ul>
		</div>
	</div>
